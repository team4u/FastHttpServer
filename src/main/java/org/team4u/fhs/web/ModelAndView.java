...
public class ModelAndView {
    ...
    public static final String SINGLE_MODEL_NAME = "model";
    ...
    /**
     * Convenient constructor to take a single model object with SINGLE_MODEL_NAME.
     *
     * @param view        View object to render
     * @param modelObject the single model object
     */
    public ModelAndView(View view, Object modelObject) {
        this.view = view;
        addObject(SINGLE_MODEL_NAME, modelObject);
    }
    ...
    public ModelAndView addObject(Object attributeValue) {
        getModelMap().put(SINGLE_MODEL_NAME, attributeValue);
        return this;
    }
    ...
    public boolean isEmpty() {
        return (view == null && (model == null || model.isEmpty()));
    }
    ...
    public ModelAndView setStatus(Integer status) {
        this.status = status;
        return this;
    }
